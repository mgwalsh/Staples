...
* Section 4 (Figure 8) shows the spatial predictions of where potentially interesting, mixed cropping systems occur in Rwanda and Tanzania. The underlying models and their validation predictions indicate that these predictions are quite reliable with ROC-AUCs of >0.8. Model validation runs (Figure 9) on a test-set show that the multilabel classifiers are quite robust and informative. 
