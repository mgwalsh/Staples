...
Note however that this approach suffers from the so called [cold start problem](https://en.wikipedia.org/wiki/Cold_start_(recommender_systems)#cite_note-Koren09-25). There are various mitigation strategies for this e.g., by including the approach that is illustrated in the next section with a [content-based filtering](https://en.wikipedia.org/wiki/Recommender_system) approach.
